    ...
    public partial class frmConsultar : Form
    {
        ...
        private void btnBorrar_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show($"¿Seguro que quiere borrar la carrera " +
                    ...
                    MessageBoxIcon.Warning) == DialogResult.Yes)
                {
                    ...
                    DBHelper.ObtenerInstancia().actualizarCarreraConSP("pa_actualizar_carrera", carreraABorrar);
        ...
        private void btnRestaurar_Click(object sender, EventArgs e)
        {
               ...
               MessageBoxIcon.Warning) == DialogResult.Yes)
            {
                ...
                DBHelper.ObtenerInstancia().actualizarCarreraConSP("pa_actualizar_carrera", carreraARestaurar);
