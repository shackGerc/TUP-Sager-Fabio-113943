    ...
    public partial class frmModificar : Form
    {
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            if (nombreCarreraOriginal != txtNombreCarrera.Text)
            {
                ...
                accesoDB.actualizarCarreraConSP("pa_actualizar_carrera", carreraModificada);
            }
            
            accesoDB.borrarMateriasConSP("pa_borrar_detalles_carrera", carreraModificada.Cod_carrera);
            accesoDB.InsertarDetallesCarreraConSP("pa_insertar_detalleCarrera", carreraModificada);
